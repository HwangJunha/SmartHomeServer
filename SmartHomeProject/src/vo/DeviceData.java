...
public class DeviceData implements Comparable<DeviceData> {
	...
	@Override
	public int compareTo(DeviceData d) {
		if(Integer.parseInt(this.time_ymd)<Integer.parseInt(d.getTimeYMD())) {
			return -1;
		}else if(Integer.parseInt(this.time_ymd)>Integer.parseInt(d.getTimeYMD())) {
			return 1;
		}
		return 0;
	}
