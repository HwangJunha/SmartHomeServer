...
<script type="text/javascript">
    function idCheck(id) { //idCheck(id) 함수는 id중복확인 버튼을 클릭하면 호출되는 함수
        frm = document.regForm; //버튼을 클릭했을 때 회원가입 폼에 아이디 값이 없으면 경고 메시지가 뜨지만 정상적으로 입력하면
 ...
 {	
    ...
    url = "SignUpSuccess.html";
    window.open(url, "SignUpSuccess", "width=300,height=150");
    form.submit();
...
<body>
    ...
    <div class="container">
        <br /> <br />
        <form method="post" action="../sign_up" id="sign_up" name="sign_up">
                ...
                <tr>
                    <td align="center" valign="middle">
                        <table border="0" align="center">
                            ...
                            <tr class="form-group">
                                <td width="20%">아이디</td>
                                <td width="80%"><input id="id" name="id" size="21"> <input
                                   class="btn btn-secondary" type="button" value="ID중복확인"
                            ...
                            <tr>
                                <td>이름</td>
                                <td><input id="name" name="name" size="21"></td>
                                
                            </tr>
 
                            <tr>
                                <td>Email</td>
                                <td><input id="email" name="email" size="21"></td>
                                
                            </tr>
 							<tr>
 								<td>핸드폰 번호</td>
 								<td>
 									<input type="text" size="7" id="tel_1" name="tel_1"> -
 									<input type="text" size="7" id="tel_2" name="tel_2"> - 
 									<input type="text" size="7" id="tel_3" name="tel_3"> 
                            ...
                            <tr>
                            	<td><input type="text" size="30" id="address" name="address" placeholder="주소"  readonly></td>
                            </tr>
                            <tr>
                            	<td><input type="text" size="30" id="address2" name="address2" placeholder="상세주소"></td>
                            </tr>
                            <tr class="form-group">
            
                                <td colspan="3" align="center"><input class="btn btn-secondary" type="button" id=signUpButton name=signUpButton value="회원가입" onclick="inputCheck()"> &nbsp; &nbsp; <input class="btn btn-secondary" type="reset" value="다시쓰기"> &nbsp; &nbsp; 
                                <input class="btn btn-secondary" type="button" value="로그인" onClick="location.href='../loginForm.html'"></td>
                            </tr>
