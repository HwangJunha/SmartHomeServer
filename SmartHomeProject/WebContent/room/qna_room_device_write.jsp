...
<body>
	...
	<header class="masthead bg-primary text-center" id="">
		...
		<section>
		<form action="RoomDeviceWritePro.bo" method="post" name="Roomform">
		<input type="hidden" name="code" id="code" value="<%=code%>" >
			<table class="text-white bg-secondary">
				<tr>
					<td style="text-align: right;"><label for="RoomName">장비 위치:</label></td>
					<td style="text-align: left;"><input type="text" name="RoomName"
						id="RoomName" /></td>
				</tr>
				<tr>
