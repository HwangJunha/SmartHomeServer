...
<%
	...
	boolean airfilter=false;
	boolean smartWindow=false;
	boolean humidifier= false;
	boolean moodLight=false;
	
	for(int i=0; i<articleList.size(); i++){
		switch(articleList.get(i).getKind()){
			case "가습기":
				humidifier=true;
				break;
			case "공기청정기":
	...
	<section id="listForm">
		...
		<h1 class="masthead-heading text-uppercase mb-2">My Home</h1>
                ...
                <div class="divider-custom divider-light">
                    ...
                    <div class="divider-custom-icon"><a href=deviceViewList.bo?code=<%=code%>><i class="fas fa-home text-whit btn-outline-light"></i></a></div>
                    <div class="divider-custom-line"></div>
                </div>
        </div>
		</header>
		 <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">구매 목록</h2>
                <!-- Icon Divider-->
