        ...
        function drawDashboard() {
          ...
          for(int i = 0; i <articleList.size(); i++){ //
            ...
            %>
 			...
 			dataRow = [new Date(<%=year%>, '10'), temperature];
            data.addRow(dataRow);
            <%
          	}
 			%>
		        ...
		        function drawDashboard2() {
		          ...
		          for(int i = 0; i <articleList.size(); i++){ //
		            ...
		            String year= str.substring(0,4);
		 			...
		 			dataRow = [new Date(<%=year%>, '10'), humidity];
		            data.addRow(dataRow);
		            <%
		          	}
		 			%>
		    ...
		    chartDrow : function(){
		        ...
		        function drawDashboard3() {
		          ...
		          for(int i = 0; i <articleList.size(); i++){ //
		        	...
		        	double discomfort=(1.8*temperature)-(0.55*(1-humidity/100))*(1.8*temperature-26)+32;
		        	String str= articleList.get(i).getTimeYMD();
		            ...
		            %>
		 			...
		 			dataRow = [new Date(<%=year%>, '10'), discomfort];
		            data.addRow(dataRow);
		            <%
		          	}
		 			%>
