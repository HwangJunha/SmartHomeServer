        ...
        function drawDashboard() {
          ...
          for(int i = 0; i <articleList.size(); i++){ //
            ...
            %>
 			...
 			dataRow = [new Date(<%=year%>, <%=month%>, '10'), temperature];
            data.addRow(dataRow);
            <%
          	}
 			%>
		        ...
		        function drawDashboard2() {
		          ...
		          for(int i = 0; i <articleList.size(); i++){ //
		            ...
		            String month=Integer.toString((Integer.parseInt(str.substring(5,6))-1));
		 			...
		 			dataRow = [new Date(<%=year%>, <%=month%>, '10'), humidity];
		            data.addRow(dataRow);
		            <%
		          	}
		 			%>
		        ...
		        function drawDashboard3() {
		          ...
		          for(int i = 0; i <articleList.size(); i++){ //
		            ...
		            String month=Integer.toString((Integer.parseInt(str.substring(5,6))-1));
		 			...
		 			dataRow = [new Date(<%=year%>, <%=month%>, '10'), dust];
		            data.addRow(dataRow);
		            <%
		          	}
		 			%>
		        ...
		        function drawDashboard3() {
		          ...
		          for(int i = 0; i <articleList.size(); i++){ //
		            ...
		            String month=Integer.toString((Integer.parseInt(str.substring(5,6))-1));
		 			...
		 			dataRow = [new Date(<%=year%>, <%=month%>, '10'), discomfort];
		            data.addRow(dataRow);
		            <%
		          	}
		 			%>
