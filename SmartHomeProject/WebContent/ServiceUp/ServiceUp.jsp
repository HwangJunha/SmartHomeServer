...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 ...
 function inputService() // 서비스 등록버튼을 누르면 실행된다
 {	
	var form = document.serviceUp;
    url = "ServiceUp/ServiceUpSuccess.html";
    window.open(url, "ServiceUp/SignUpSuccess", "width=300,height=150");
    form.submit();
    ...
    <body id="page-top">
        ...
        <form action="serviceUp" method="POST" id=serviceUp name=serviceUp>
            <div class="container">
                ...
                <div class="divider-custom">
                    <div>
                    	<h2 class= "text-center text-uppercase text-secondary mb-0">제품 목록</h2>
                ...
                <div class="row">
                    ...
                    <!-- Portfolio Item 1-->
                    <div class="col-md-6 col-lg-4 mb-5 text-center mt-4">
                        ...
                        <input type="checkbox" name="product" value="공기청정기">공기청정기
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5 text-center mt-4">
                        ...
                        <input type="checkbox" name="product" value="도어락">도어락
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-6 col-lg-4 mb-5 text-center mt-4">
                        ...
                        <input type="checkbox" name="product" value="가습기">가습기
                    </div>
                    <!-- Portfolio Item 4-->
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 text-center mt-4">
                        ...
                        <input type="checkbox" name="product" value="무드등">무드등
                    </div>
                    <!-- Portfolio Item 5-->
                    <div class="col-md-6 col-lg-4 mb-5 mb-md-0 text-center mt-4">
                        ...
                        <input class="btn btn-xl" type="checkbox" name="product" value="스마트창문">스마트윈도우
                    </div>
                    <!-- Portfolio Item 6-->
                    <div class="col-md-6 col-lg-4 text-center mt-4">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
                         ...
                         <input type="checkbox" name="product" value="센서">센서
                    </div>
                     
                </div>
                <div class="text-center mt-4">
                     	<input class="btn btn-xl btn-outline-primary" type="button" id=serviceUpButton name=serviceButton value="서비스 등록" onclick="inputService()">
                </div>
            </div>
            </form>
        </section>
