...
<header class="masthead bg-primary text-center" id="">
		...
		<div class="bg-secondary" style="margin: 0 auto; border: 1px; width:350px; height:350px;">
			<form name="ipInsertForm" method="get" action="ServiceIpPro.am?id=<%=id %>" method="post">
		
		<input type = "hidden" name = "page" value = "<%=nowPage %>"/>
		<table class="text-white bg-secondary">
		<tr>
				<th colspan="2">IP 등록</th>
		</tr>
		<tr>
		...
		<section id = "commandCell">
			<input style="color: #FFFFFF; background: #57B99D; font-size:1em; border-radius:0.5em; padding:5px 20px;" type="submit" value = "입력"/>
			&nbsp;&nbsp;
