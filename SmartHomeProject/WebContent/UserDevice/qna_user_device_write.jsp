...
<body>
	...
	<header class="masthead bg-primary text-center" id="">
		...
		<h1 class="masthead-heading text-white text-uppercase mb-2">my home</h1>
                ...
                <div class="bg-secondary" style="margin: 0 auto; border: 1px; width:600px; height:600px;">
                	<form action="UserDeviceWritePro.am" method="post" name="UserDeviceform">
			<table class="text-white bg-secondary">
				...
				<tr>
					<td style="text-align: right;"><label for="model">장비 모델(없을 시 temp):</label></td>
					<td style="text-align: left;"><input type="text" name="model"
						id="model" required="required" /></td>
				</tr>
				<tr>
					<td style="text-align: right;"><label for=pcDate">구매 날짜:(0000-00-00)</label></td>
					<td style="text-align: left;"><input type="text" name="pcDate"
						id="pcDate" required="required" /></td>
				</tr>
			</table>
