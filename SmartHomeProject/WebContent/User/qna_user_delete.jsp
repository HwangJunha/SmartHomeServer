...
<header class="masthead bg-primary text-center" id="">
		...
		<div class="bg-secondary" style="margin: 0 auto; border: 1px; width:400px; height:350px;">
			<form name="deleteForm" action="UserDeletePro.am?id=<%=id %>" method="post">
		<input type = "hidden" name = "page" value = "<%=nowPage %>"/>
		<table class="text-white bg-secondary">
		<tr>
				<th colspan="2">사용자 삭제</th>
		</tr>
		<tr>
